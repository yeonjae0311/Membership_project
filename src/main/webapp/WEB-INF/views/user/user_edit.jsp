	...
	<div id="user_edit_div">
		<div id="member_info_head_div">
			<div>
				...
				<div id="user_info_form">
					<div class="member_info_head" onclick="move_to(event)">${id.m_username}</div>
					
					<div class="member_info_head" onclick="move_to(event)">${id.m_email}</div>
				</div>
			</div>
		</div>
		...
		<div id="member_info_body_div">
			<div id="user_edit_profile" class="member_info_body">
				<img src="${pageContext.request.contextPath}/resources/img/user/user_profile.png" onclick="move_to(event)" >
				<div onclick="move_to(event)">
					user_edit_profile
				</div>
			</div>
			
			<div id="user_order_list" class="member_info_body">
				<img src="${pageContext.request.contextPath}/resources/img/user/won.png" onclick="move_to(event)" >
				<div onclick="move_to(event)">
					user_order_list
				</div>
			</div>
			...
			<div id="user_post_list" class="member_info_body">
				<img src="${pageContext.request.contextPath}/resources/img/user/pen.png" onclick="move_to(event)" >
				<div onclick="move_to(event)">
					user_order_list
				</div>
			</div>
