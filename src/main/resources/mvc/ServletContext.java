...
public class ServletContext implements WebMvcConfigurer {
	...
	@Bean
	public MainController main_controller(StoryDAO story_dao, BoardDAO board_dao, PMemberDAO pmemberdao) {
		return new MainController(story_dao, board_dao, pmemberdao);
	}
